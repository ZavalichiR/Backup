	...
	<header class="header">
		...
		<div class=<main_section">
			<script type="text/javascript">
				...
				<label class="cautare" >Autor</label>
				<input type="text" value="" id="autor">
				<label class="cautare">Titlu</label>
				<input type="text" value="" id="titlu">
				<button onclick="Cauta();">Cauta</button></br></br>
				
				<form method="post" action="afisare.php">
					<button onclick="localSt();"  >LocalStorage</button>
				</form>
